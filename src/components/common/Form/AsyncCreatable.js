...
export default (props) => {
  ...
  React.useEffect(() => {
    if (ref.current && ref.current.select.select.select.controlRef.closest('.form-control') && props['data-cy']) {
      ref.current.select.select.select.controlRef.closest('.form-control').setAttribute('data-cy', props['data-cy']);
    }
  }, [props]);
