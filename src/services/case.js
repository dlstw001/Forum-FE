...
export default class CaseServices extends BaseServices {
  constructor(props) {
    super(props);
    this.url = '/case';
  ...
  relatedByTagCases = (payload) => this.http.get(`${this.url}/relatedByTagCases`, payload);
  ...
  createReply = (postId, payload) => this.http.post(`${this.url}/${postId}/reply`, payload);
  getReply = (postId, payload) => this.http.get(`${this.url}/${postId}/reply`, payload);
  getIndex = (postId) => this.http.get(`${this.url}/${postId}/reply/index`);
  getHottestTags = (payload) => this.http.get(`${this.url}/hotTags`, payload);
}
